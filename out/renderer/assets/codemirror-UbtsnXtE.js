import { f as findClusterBreak$1, S as StyleModule, k as keyName, b as base, s as shift, c as crelt } from "./vendor-BuqXNoU1.js";
...
const base00$2 = "#0d1117", base01$2 = "#c9d1d9", base02$2 = "#264F78", base03$2 = "#8b949e", base04$2 = "#ffffff", base05$2 = "#7ee787", base06$2 = "#d2a8ff", base07$2 = "#79c0ff", base08$2 = "#ff7b72", base09$2 = "#a5d6ff", base0A$1 = "#2c333a", base0B$1 = "#3c444d", base0C$1 = "#ffab70", base0D$1 = "#161b22", base0E$1 = "#30363d", base0F$1 = "#21262d";
const invalid$2 = "#f97583", highlightBackground$2 = "#2d333b1a", tooltipBackground$2 = "#21262d", cursor$2 = base04$2, selection$2 = base02$2, activeBracketBg$2 = "#3a587a75", activeBracketBorder$2 = "#4d90fe", diagnosticWarning$2 = "#d29922", selectionMatch$2 = "#3a587a55", linkColor$2 = "#58a6ff", visitedLinkColor$2 = "#bc8cff";
const addedBackground$2 = "#2ea04350", removedBackground$2 = "#f8514940", addedText$2 = "#7ee787", removedText$2 = "#ff7b72";
const githubDarkTheme = /* @__PURE__ */ EditorView.theme({
  // Base editor styles
  "&": {
    color: base01$2,
    backgroundColor: base00$2,
  ...
  ".cm-searchMatch.cm-searchMatch-selected": {
    backgroundColor: activeBracketBorder$2,
    color: base04$2,
  ...
  ".cm-diagnostic": {
    "&-error": {
      borderLeft: `3px solid ${invalid$2}`
    },
    "&-warning": {
      borderLeft: `3px solid ${diagnosticWarning$2}`
    },
    "&-info": {
      borderLeft: `3px solid ${linkColor$2}`
    }
  },
  ".cm-lintPoint-error": {
    borderBottom: `2px wavy ${invalid$2}`
  },
  ".cm-lintPoint-warning": {
  ...
  "&.cm-focused": {
    outline: "none",
    boxShadow: `0 0 0 2px ${base00$2}, 0 0 0 3px ${linkColor$2}40`
  },
  // Scrollbars
  ...
  "& .cm-scroller::-webkit-scrollbar-thumb": {
    backgroundColor: base0E$1,
    borderRadius: generalScroller$2.borderRadius,
    border: `3px solid ${base0D$1}`
  },
  "& .cm-scroller::-webkit-scrollbar-thumb:hover": {
    backgroundColor: base0B$1
  },
  // Ghost text
  ".cm-ghostText": {
    opacity: "0.5",
...
const githubDarkHighlightStyle = /* @__PURE__ */ HighlightStyle.define([
  ...
  { tag: tags.keyword, color: base08$2, fontWeight: "bold" },
  { tag: tags.controlKeyword, color: base08$2, fontWeight: "bold" },
  { tag: tags.moduleKeyword, color: base08$2, fontWeight: "bold" },
  // Names and variables
  { tag: [tags.name, tags.deleted, tags.character, tags.macroName], color: base07$2 },
  { tag: [tags.variableName], color: base07$2 },
  { tag: [tags.propertyName], color: base06$2, fontStyle: "normal" },
  // Classes and types
  { tag: [tags.typeName], color: base08$2 },
  { tag: [tags.className], color: base06$2, fontStyle: "italic" },
  { tag: [tags.namespace], color: base07$2, fontStyle: "italic" },
  // Operators and punctuation
  { tag: [tags.operator, tags.operatorKeyword], color: base01$2 },
  { tag: [tags.bracket], color: base03$2 },
  { tag: [tags.brace], color: base03$2 },
  { tag: [tags.punctuation], color: base03$2 },
  // Functions and parameters
  { tag: [/* @__PURE__ */ tags.function(tags.variableName), tags.labelName], color: base05$2 },
  { tag: [/* @__PURE__ */ tags.definition(tags.variableName)], color: base07$2 },
  // Constants and literals
  { tag: tags.number, color: base0C$1 },
  { tag: tags.changed, color: base0C$1 },
  { tag: tags.annotation, color: invalid$2, fontStyle: "italic" },
  { tag: tags.modifier, color: base0C$1, fontStyle: "italic" },
  { tag: tags.self, color: base0C$1 },
  { tag: [tags.color, /* @__PURE__ */ tags.constant(tags.name), /* @__PURE__ */ tags.standard(tags.name)], color: base0C$1 },
  { tag: [tags.atom, tags.bool, /* @__PURE__ */ tags.special(tags.variableName)], color: base0C$1 },
  // Strings and regex
  { tag: [tags.processingInstruction, tags.inserted], color: base05$2 },
  { tag: [/* @__PURE__ */ tags.special(tags.string), tags.regexp], color: base09$2 },
  { tag: tags.string, color: base09$2 },
  // Punctuation and structure
  { tag: /* @__PURE__ */ tags.definition(tags.typeName), color: base08$2, fontWeight: "bold" },
  // Comments and documentation
  { tag: tags.meta, color: base03$2 },
  { tag: tags.comment, fontStyle: "italic", color: base03$2 },
  { tag: tags.docComment, fontStyle: "italic", color: base03$2 },
  // HTML/XML elements
  { tag: [tags.tagName], color: base05$2 },
  { tag: [tags.attributeName], color: base06$2 },
  // Markdown and text formatting
  { tag: [tags.heading], fontWeight: "bold", color: base07$2 },
  { tag: [tags.strong], fontWeight: "bold", color: base07$2 },
  { tag: [tags.emphasis], fontStyle: "italic", color: base09$2 },
  // Links and URLs
  { tag: [tags.link], color: visitedLinkColor$2, fontWeight: "500", textDecoration: "underline", textUnderlinePosition: "under" },
  {
    tag: [tags.url],
    color: linkColor$2,
    textDecoration: "underline",
  ...
  // Special states
  { tag: [tags.invalid], color: base01$2, textDecoration: "underline wavy", borderBottom: `1px wavy ${invalid$2}` },
  { tag: [tags.strikethrough], color: invalid$2, textDecoration: "line-through" },
  // Enhanced syntax highlighting
  { tag: /* @__PURE__ */ tags.constant(tags.name), color: base0C$1 },
  { tag: tags.deleted, color: invalid$2 },
  { tag: tags.squareBracket, color: base03$2 },
  { tag: tags.angleBracket, color: base03$2 },
  // Additional specific styles
  { tag: tags.monospace, color: base01$2 },
  { tag: [tags.contentSeparator], color: base07$2 },
  { tag: tags.quote, color: base03$2 }
]);
const githubDark = [
  githubDarkTheme,
...
const base00$1 = "#ffffff", base01$1 = "#24292e", base02$1 = "#BBDFFF", base03$1 = "#6e7781", base04$1 = "#f6f8fa", base05$1 = "#116329", base06$1 = "#6a737d", base07$1 = "#6f42c1", base08$1 = "#005cc5", base09$1 = "#d73a49", base0A = "#032f62", base0B = "#22863a", base0C = "#e36209", base0D = "#f1f8ff", base0E = "#e1e4e8", base0F = "#f8f9fa";
const invalid$1 = "#cb2431", highlightBackground$1 = "#BBDFFF20", tooltipBackground$1 = base0F, cursor$1 = base01$1, selection$1 = base02$1, activeBracketBg$1 = "#e8f0fe", activeBracketBorder$1 = "#0366d6", diagnosticWarning$1 = "#b08800", selectionMatch$1 = "#79b8ff40", linkColor$1 = "#0969da", visitedLinkColor$1 = "#8250df";
const addedBackground$1 = "#e6ffec80", removedBackground$1 = "#ffebe980", addedText$1 = "#0f6d31", removedText$1 = "#cf222e";
const githubLightTheme = /* @__PURE__ */ EditorView.theme({
  ...
  ".cm-lineNumbers": {
    ...
    lineHeight: generalGutter$1.lineHeight
  },
  ".cm-foldGutter": {
    fontSize: generalGutter$1.fontSize,
    lineHeight: generalGutter$1.lineHeight
  ...
  "ins.cm-insertedLine, ins.cm-insertedLine:not(:has(.cm-changedText))": {
    ...
    padding: generalDiff$1.insertedLinePadding,
    borderRadius: generalDiff$1.borderRadious,
    border: `1px solid ${addedText$1}30`
  },
  "ins.cm-insertedLine .cm-changedText": {
    background: "transparent !important"
  },
  ...
  "del.cm-deletedLine, del, del:not(:has(.cm-deletedText))": {
    ...
    padding: generalDiff$1.insertedLinePadding,
    borderRadius: generalDiff$1.borderRadious,
    border: `1px solid ${removedText$1}30`
  },
  "del .cm-deletedText, del .cm-changedText": {
    background: "transparent !important"
  },
  ...
  ".cm-diagnostic": {
    "&-error": {
      borderLeft: `3px solid ${invalid$1}`
    },
    "&-warning": {
      borderLeft: `3px solid ${diagnosticWarning$1}`
    },
    "&-info": {
      borderLeft: `3px solid ${linkColor$1}`
    }
  },
  ".cm-lintPoint-error": {
    borderBottom: `2px wavy ${invalid$1}`
  },
  ".cm-lintPoint-warning": {
    borderBottom: `2px wavy ${diagnosticWarning$1}`
  },
  // Matching brackets
  ".cm-matchingBracket": {
  ...
  "&.cm-focused": {
    outline: "none",
    boxShadow: `0 0 0 2px ${base00$1}, 0 0 0 3px ${linkColor$1}40`
  },
  // Scrollbars
  "& .cm-scroller::-webkit-scrollbar": {
...
const githubLightHighlightStyle = /* @__PURE__ */ HighlightStyle.define([
  // Keywords and control flow
  { tag: tags.keyword, color: base09$1, fontWeight: "bold" },
  { tag: tags.controlKeyword, color: base09$1, fontWeight: "bold" },
  { tag: tags.moduleKeyword, color: base09$1, fontWeight: "bold" },
  // Names and variables
  { tag: [tags.name, tags.deleted, tags.character, tags.macroName], color: base08$1 },
  { tag: [tags.variableName], color: base08$1 },
  { tag: [tags.propertyName], color: base07$1, fontStyle: "normal" },
  // Classes and types
  { tag: [tags.typeName], color: base09$1 },
  { tag: [tags.className], color: base07$1, fontStyle: "italic" },
  { tag: [tags.namespace], color: base08$1, fontStyle: "italic" },
  // Operators and punctuation
  { tag: [tags.operator, tags.operatorKeyword], color: base01$1 },
  { tag: [tags.bracket], color: base06$1 },
  { tag: [tags.brace], color: base06$1 },
  { tag: [tags.punctuation], color: base06$1 },
  // Functions and parameters
  { tag: [/* @__PURE__ */ tags.function(tags.variableName), tags.labelName], color: base0B },
  { tag: [/* @__PURE__ */ tags.definition(tags.variableName)], color: base08$1 },
  // Constants and literals
  { tag: tags.number, color: base0C },
  { tag: tags.changed, color: base0C },
  { tag: tags.annotation, color: invalid$1, fontStyle: "italic" },
  ...
  // Punctuation and structure
  { tag: /* @__PURE__ */ tags.definition(tags.typeName), color: base09$1, fontWeight: "bold" },
  // Comments and documentation
  { tag: tags.meta, color: base06$1 },
  { tag: tags.comment, fontStyle: "italic", color: base06$1 },
  { tag: tags.docComment, fontStyle: "italic", color: base06$1 },
  // HTML/XML elements
  { tag: [tags.tagName], color: base05$1 },
  { tag: [tags.attributeName], color: base07$1 },
  // Markdown and text formatting
  { tag: [tags.heading], fontWeight: "bold", color: base08$1 },
  { tag: [tags.strong], fontWeight: "bold", color: base08$1 },
  { tag: [tags.emphasis], fontStyle: "italic", color: base0A },
  // Links and URLs
  {
    tag: [tags.link],
    color: visitedLinkColor$1,
    fontWeight: "500",
    textDecoration: "underline",
  ...
  // Special states
  {
    ...
    borderBottom: `1px wavy ${invalid$1}`
  },
  { tag: [tags.strikethrough], color: invalid$1, textDecoration: "line-through" },
  // Enhanced syntax highlighting
  { tag: /* @__PURE__ */ tags.constant(tags.name), color: base0C },
  { tag: tags.deleted, color: invalid$1 },
  { tag: tags.squareBracket, color: base06$1 },
  { tag: tags.angleBracket, color: base06$1 },
  // Additional specific styles
  { tag: tags.monospace, color: base01$1 },
  { tag: [tags.contentSeparator], color: base08$1 },
  { tag: tags.quote, color: base06$1 }
]);
const githubLight = [
  githubLightTheme,
...
const base00 = "#272822", base01 = "#f8f8f2", base02 = "#88846f", base03 = "#f8f8f0", base04 = "#F92672", base05 = "#FD971F", base06 = "#66D9EF", base07 = "#E6DB74", base08 = "#AE81FF", base09 = "#A6E22E";
const invalid = "#F44747", darkBackground = "#414339", highlightBackground = "#3e3d3257", tooltipBackground = "#34352f", selection = "#49483E", selectionMatch = "#75715e70", cursor = base03, activeBracketBg = "#75715E55", activeBracketBorder = base06, diagnosticWarning = base05, linkColor = base06, visitedLinkColor = base08;
const addedBackground = "#3d4d3880", removedBackground = "#4d393980", addedText = "#A6E22E", removedText = "#F92672";
...
export {
  ...
  LRLanguage as a,
  foldInside as b,
  LanguageSupport as c,
  delimitedIndent as d,
  completeAnyWord as e,
  foldNodeProp as f,
  StateField as g,
  EditorState as h,
  indentNodeProp as i,
